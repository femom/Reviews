...
import { HiUser, HiMail, HiLockClosed, HiArrowRight, HiLogin } from "react-icons/hi";
              ...
              <div>
                ...
                <div className="flex gap-4 p-4 rounded-xl bg-slate-100 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700">
                  <label className="flex items-center gap-2 cursor-pointer">
                    ...
                    />
                    <span className="text-slate-700 dark:text-slate-300 text-sm">Utilisateur</span>
                  </label>
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      type="radio"
                      ...
                      className="w-4 h-4 text-emerald-600 focus:ring-emerald-500"
                    />
                    <span className="text-slate-700 dark:text-slate-300 text-sm">Admin</span>
                  </label>
                </div>
              </div>
